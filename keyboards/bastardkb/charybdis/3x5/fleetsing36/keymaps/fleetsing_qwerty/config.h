...
/*
 * Selects layout_positions_qwerty.h over layout_positions.h in the shared
 * users/fleetsing/layouts/charybdis_3x5/fi_autoshift.c, which is compiled
 * once per keymap and cannot otherwise tell which arrangement is active.
 */
#define FLEETSING_LAYOUT_QWERTY
